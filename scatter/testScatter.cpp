...
public:
    ...
    static Grafo crearGrafoParaUnionA() {
        Grafo g(6, 7, 10);
    ...
    static void test_combinarUsaOpcionAConUnionValida() {
    ...
    static Grafo crearGrafoParaUnionB() {
        Grafo g(6, 6, 10);
        g.insertarArista(0, 1, 1, 1);
        g.insertarArista(1, 2, 1, 1);
        g.insertarArista(2, 5, 1, 1);
    ...
    static void test_combinarUsaOpcionBCuandoAFalla() {
    ...
    static void test_combinarRetornaMejorPadreSiNingunaUnionEsFactible() {
        Grafo g(6, 6, 10);
        g.insertarArista(0, 1, 1, 1);
        g.insertarArista(1, 2, 1, 1);
        g.insertarArista(2, 5, 1, 1);
    ...
    static void test_combinarDescartaUnionQueExcedePresupuesto() {
        Grafo g(6, 7, 2);
        g.insertarArista(0, 1, 1, 1);
        g.insertarArista(1, 2, 1, 1);
        g.insertarArista(2, 5, 1, 1);
    ...
    static void test_combinarInsertaSubcadenaEnGrafoDenso() {
...
int main() {
    TestScatter::test_combinarUsaOpcionAConUnionValida();
    TestScatter::test_combinarUsaOpcionBCuandoAFalla();
    TestScatter::test_combinarRetornaMejorPadreSiNingunaUnionEsFactible();
    TestScatter::test_combinarDescartaUnionQueExcedePresupuesto();
    TestScatter::test_combinarInsertaSubcadenaEnGrafoDenso();
    TestScatter::test_resolverConCaminoUnicoDevuelveEseCamino();
    TestScatter::test_resolverSobreGrafoGrandeRespetaInvariantes();
