...
void test_resolverCaminoLineal() {
...
void test_resolverEligeMejorRazonBeneficioCosto() {
...
Grafo crearGrafoRazonFraccionaria() {
    Grafo g(4, 4, 20);
...
void test_resolverEligeMejorRazonFraccionaria() {
...
void test_resolverRespetaPesoDisponible() {
...
Grafo crearGrafoSinSalida() {
    Grafo g(3, 1, 10);
    g.insertarArista(0, 1, 1, 5);
    return g;
}

void test_resolverCaminoSinSalidaQuedaIncompleto() {
...
int main() {
    test_resolverCaminoLineal();
    test_resolverEligeMejorRazonBeneficioCosto();
    test_resolverEligeMejorRazonFraccionaria();
    test_resolverRespetaPesoDisponible();
    test_resolverCaminoSinSalidaQuedaIncompleto();
