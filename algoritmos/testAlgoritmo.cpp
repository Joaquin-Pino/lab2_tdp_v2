...
public:
    ...
    static void test_combinar_sin_duplicados() {
    ...
    static void test_combinar_k_mayor_que_candidatos() {
        auto res = Algoritmo::combinar({1, 2}, 3);
        assert(res.empty());
        std::cout << "test_combinar_k_mayor_que_candidatos: OK\n";
    }

    static void test_combinar_candidatos_vacios() {
    ...
    static void test_permutar_k2_incluye_ambos_ordenes() {
    ...
    static void test_permutar_k_igual_candidatos() {
    ...
    static void test_permutar_k_mayor_que_candidatos() {
        auto res = Algoritmo::permutar({1, 2}, 3);
        assert(res.empty());
        std::cout << "test_permutar_k_mayor_que_candidatos: OK\n";
    }

    static void test_permutar_candidatos_vacios() {
...
int main() {
    TestAlgoritmo::test_combinar_k1();
    TestAlgoritmo::test_combinar_k2();
    TestAlgoritmo::test_combinar_sin_duplicados();
    TestAlgoritmo::test_combinar_k_mayor_que_candidatos();
    TestAlgoritmo::test_combinar_candidatos_vacios();
    TestAlgoritmo::test_permutar_k1();
    TestAlgoritmo::test_permutar_k2_incluye_ambos_ordenes();
    TestAlgoritmo::test_permutar_k_igual_candidatos();
    TestAlgoritmo::test_permutar_k0();
    TestAlgoritmo::test_permutar_k_mayor_que_candidatos();
    TestAlgoritmo::test_permutar_candidatos_vacios();
