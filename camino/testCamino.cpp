...
public:
    ...
    static void test_agregarNodoDuplicado() {
        Grafo g = crearGrafo();
        Camino c(std::vector<int>{}, g);
    ...
    static void test_nodoFueVisitado() {
        Grafo g = crearGrafo();
        Camino c(std::vector<int>{}, g);
    ...
    static void test_eliminarNodoMantieneTotalesConsistentes() {
        Grafo g = crearGrafo();
    ...
    static void test_eliminarNodoRechazaExtremosYAusentes() {
        Grafo g = crearGrafo();
        Camino c(std::vector<int>{0, 1, 2, 3}, g);
    ...
    static void test_eliminarNodoRechazaSiNoHayAristaPuente() {
    ...
    static void test_verificarCamino() {
    ...
    static void test_getUltimoNodo() {
        Grafo g = crearGrafo();
        Camino c(std::vector<int>{}, g);
    ...
    static void test_intercambiarNodos() {
...
int main() {
    TestCamino::test_agregarNodo();
    TestCamino::test_agregarNodoDuplicado();
    TestCamino::test_nodoFueVisitado();
    TestCamino::test_eliminarNodo();
    TestCamino::test_eliminarNodoMantieneTotalesConsistentes();
    TestCamino::test_eliminarNodoRechazaExtremosYAusentes();
    TestCamino::test_eliminarNodoRechazaSiNoHayAristaPuente();
    TestCamino::test_verificarCamino();
    TestCamino::test_getUltimoNodo();
    TestCamino::test_intercambiarNodos();
    TestCamino::test_concatenar();
    TestCamino::test_copiaCamino();
