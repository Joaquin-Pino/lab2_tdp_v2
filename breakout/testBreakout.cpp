...
public:
    ...
    static void test_resolverNuncaEmpeoraElGolosoYRespetaPresupuesto() {
...
int main() {
    TestBreakout::test_resolverEncuentraOptimoConocido();
    TestBreakout::test_resolverConCeroIteracionesNoCambiaSolucionInicial();
    TestBreakout::test_resolverNuncaEmpeoraElGolosoYRespetaPresupuesto();
